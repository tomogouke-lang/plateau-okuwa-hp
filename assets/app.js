(function(){
  ...
  const codes=view==="guide"?`<section class="soft" id="codes"><div class="inner"><div class="section-head"><span class="eyebrow">SERVICE CODES</span><h2>主なサービスコード</h2><p>紹介・請求時の照合用です。実際の算定は個別のケアプランと算定状況によります。</p></div><div class="code-table-wrap"><table class="code-table"><thead><tr><th>区分</th><th>内容</th><th>サービスコード</th></tr></thead><tbody><tr><td>通所介護</td><td>7時間以上8時間未満／要介護1〜5</td><td>15 2441〜2445</td></tr><tr><td>介護予防型</td><td>週1回程度／週2回程度</td><td>A6 1111／A6 1121</td></tr><tr><td>主な加算・減算</td><td>入浴介助加算Ⅰ／個別機能訓練加算Ⅰイ／送迎減算</td><td>15 5301／15 5051／15 5612</td></tr></tbody></table></div><p class="note">根拠：厚生労働省の介護サービスコード表、金沢市総合事業サービスコード表（令和8年6月1日以降）。</p></div></section>`:"";
